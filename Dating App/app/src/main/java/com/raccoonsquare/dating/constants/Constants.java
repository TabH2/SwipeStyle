...
public interface Constants {
    ...
    String WEB_SITE = "https://dating.raccoonsquare.com/";  //web site url address
    ...
    String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCA";
    ...
    String API_DOMAIN = "http://10.0.2.2/";  // url address to which the application sends requests | with back slash "/" at the end | example: https://mysite.com/ | for emulator on localhost: http://10.0.2.2/
